...
Read `~/.openclaw/workspace/skills/ljg-skills/skills/ljg-card/assets/long_template.html`
...
```bash
node ~/.openclaw/workspace/skills/ljg-skills/skills/ljg-card/assets/capture.js /tmp/ljg_cast_long_{name}.html ~/Downloads/{name}.png 1080 800 fullpage
```
